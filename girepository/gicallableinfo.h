...
GI_AVAILABLE_IN_ALL
gboolean               gi_callable_info_has_sync (GICallableInfo *info);

GI_AVAILABLE_IN_ALL
gboolean               gi_callable_info_has_async (GICallableInfo *info);

GI_AVAILABLE_IN_ALL
gboolean               gi_callable_info_has_finish (GICallableInfo *info);
